<?php
// CAMPEONATO 1
$camp1_ativo = 'ATIVO'; //DEFINIE SE APARECE OU NÃO O BOTÃO DE INSCREVER NO CAMP (ATIVO)
$status_camp1 = 'ENCERRADO'; //TEXTUAL
...
$qrcode_camp1 = 'FREE'; //DEFINE CAMINHO DO ARQUIVO DE QRCODE DO CAMP <img src="assets/img/camp/qrcode_camp1.png">
$chavepix_camp1 = 'FREE'; // DEFINE A CHAVE PIX DO CAMP
$linkpix_camp1 = ''; // DEFINE O LINK DO PIX DO CAMP
$inscricao_camp1 = 'inscricao_camp1.php#?id=1'; //DEFINE O LINK DA PAGINA DE INSCRIÇÃO E O ID DO EVENTO
//REGRAS CAMP 1

$regras_gerais_camp1 = '<br> 
...
$regras_banimento_camp1 = '<br> 
    ...
    - Qualquer evento que envolva atitudes tóxicas/depreciativas/discriminatórias devem ser reportadas para um ADM do Discord para que medidas sejam tomadas;<br>
    - Suspeita de trapaça ou uso de aplicativos de terceiros levará o time que estiver utilizando à desclassificação.
    </div>';

$regras_reemb_camp1 = '<br> 
    <div style="font-size: 14px" class="text-justify" style"padding-left: 20px">
                            ...
                            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="100">
                                ...
                                <div class="member-info">
                                    ...
                                    if ($camp1_ativo == 'ATIVO') {
                                        echo '<div class="row">
                                    <div style="margin-left: 0px" class="mt-3 text-center"><a href="" data-toggle="modal" data-target="#inscricaoModal" class="plan-btn scrollto">Inscrever</a></div>
                                    </div>';
                                    } else {
                            ...
                            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="100">
                                ...
                                <div class="member-info">
                                    ...
                                    <div class="member-info">
                                        ...
                                        <p class="text-justify"><strong>4) CONFIRMAÇÃO:</strong> Recebemos o seu comprovante e confirmamos seu registro de inscrição.</p>
                        ...
                        <div class="col-lg-12">
                            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="100">
                                ...
                                <div class="member-info">
                                    <div class="row">
                                        <img src="assets/img/logo-icon.png">
                                        <h4 style="padding-left: 10px; padding-top: 2px">REGRAS DO CAMPEONATO</h4>
                                    </div>
                                                ...
                                                <div class="member-info">
                                                    ...
                                                    <div class="member-info">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-md-4">
                                                                <label for="inlineFormInputName1">Nome 2º Integrante</label>
                                                                <input name="nome2_reserva" type="text" class="form-control mb-2 mr-sm-2 cpf" id="inputcpf" placeholder="Nome 2º Integrante" >
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="inlineFormInputName3">Nick 2º Integrante</label>
                                                                <input name="nick2_reserva" type="text" class="form-control mb-2 mr-sm-2 fone" id="infputfone" placeholder="Nick 2º Integrante" >
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="inlineFormInputName5">Discord 2º Integrante</label>
                                                                <input name="discord2_reserva" type="text" class="form-control mb-2 mr-sm-2" id="inlineFormInputName5" placeholder="Discord 2º Integrante" >
                                                            </div>
                                                        </div><hr>
